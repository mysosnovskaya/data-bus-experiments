...
dpcpp -g -O3 -std=c++17 -DMKL_ILP64 -I${MKLROOT}/include ./bus-bandwidth-collector/BasBandwidthCollector.cpp -L${MKLROOT}/lib/intel64 -lmkl_intel_ilp64 -lmkl_sequential -lmkl_core -lpthread -lm -ldl -o databuscollector && chmod +x databuscollector
